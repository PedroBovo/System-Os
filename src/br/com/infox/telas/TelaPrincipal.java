...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(931, 577));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        // as linhas abaixo subistituem a label lblData pela data atual 
        // do sistema ao inicializar o form
        Date data = new Date();
        
        // a linha abaixo cria um objeto que pode editar datas
        DateFormat formatador = DateFormat.getDateInstance(DateFormat.SHORT);
        // a linha abaixo subistitui a Data lblData pela classe de formatação
        lblData.setText(formatador.format(data));
    }//GEN-LAST:event_formWindowActivated

    private void menOpcSaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menOpcSaiActionPerformed
        // exibe uma caixa de dialogo
        // essa variavel gera uma caixa de dialogo
        //                                      tamanho, texto da caixa de dialogo,  titulo,    botões sim ou não
        int sair = JOptionPane.showConfirmDialog(null,"Tem certeza que deseja sair?", "Atenção", JOptionPane.YES_NO_OPTION);
        // a linha abaixo faz uma estrutura de decisao caso clique em Yes a tela fecha
    ...
    private void menAjuSobActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menAjuSobActionPerformed
        ...
        // a linha abaixo abre a tela sobre ao clicar em ajuda/sobre
        sobre.setVisible(true);
        
    }//GEN-LAST:event_menAjuSobActionPerformed

    private void menCadUsuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menCadUsuActionPerformed
        // as linhas abaixo elas abrem o form TelaUsuário dentro do DeskTop pane
    ...
    private void menCadCliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menCadCliActionPerformed
        // as linhas abaxo abrem o form Tela Cliente dentro do DeskTop pane
    ...
    private void menCadOsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menCadOsActionPerformed
        // As linhas abaixo abrem o form Tela Os dentro do DesksTop pane
